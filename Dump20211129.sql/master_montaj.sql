...
CREATE TABLE `montaj` (
  ...
  `KitEnjeksiyonCinsi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  ...
  `ECUCinsi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `ECUTipi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `ECUSeriNo` varchar(40) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  ...
  `SamandiraCinsi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `SamandiraTipi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `SamandiraCapi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `SamandiraSeriNo` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `EnjektorRengi` varchar(20) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `EnjektorKutukNo` varchar(20) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `EnjektorMontajKodu` varchar(20) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  ...
  `AracKullanimAmaci` varchar(40) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `TipOnayNo` varchar(20) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `VerilisTarihi` datetime(6) DEFAULT NULL,
  `DonusumCinsi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `FaturaNo` varchar(50) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `MontajTespitNo` varchar(50) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `MontajBaslamaTarihi` datetime(6) DEFAULT NULL,
  `MontajBitisTarihi` datetime(6) DEFAULT NULL,
  `KabulFormuNo` varchar(10) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL
