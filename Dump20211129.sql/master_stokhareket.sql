...
CREATE TABLE `stokhareket` (
  ...
  `Saat` varchar(10) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `EvrakNo` varchar(20) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `Aciklama` varchar(255) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `StokBirimi` varchar(50) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `KdvDurumu` varchar(5) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
