...
CREATE TABLE `vwstoklistesigriddoldur` (
  ...
  `StokGrupAdi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `StokBirimi` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `StokUstBirim` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
