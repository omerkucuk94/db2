...
CREATE TABLE `vwfatura` (
  ...
  `IrsaliyeNo` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Aciklama` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `FaturaNo` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
