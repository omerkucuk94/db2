...
CREATE TABLE `cariarac` (
  ...
  `MarkaAdi` varchar(50) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `IDAracTipi` int DEFAULT NULL,
  `AracTipAdi` varchar(50) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  `IDAltModel` int DEFAULT NULL,
  `AltModelAdi` varchar(40) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
  ...
  `Renk` varchar(30) CHARACTER SET utf8 COLLATE utf8 DEFAULT NULL,
